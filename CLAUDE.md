# LP -- Cassandra Miranda

Repositorio standalone da landing page de Cassandra Miranda.
...
- **Cliente:** Cassandra Miranda
- **GitHub:** https://github.com/emaildozotti/Cassandra-Maria-Meneses-Miranda
- **Vercel:** https://cassandra-miranda.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Cassandra Miranda ao ar"
...
- O remote `origin` = `emaildozotti/Cassandra-Maria-Meneses-Miranda` -- nao alterar
